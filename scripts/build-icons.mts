...
const iconDir = path.join(cwd, "src", "components", "ui", "Icon");

await fsExtra.ensureDir(iconDir);

const inputDir = path.join(iconDir, "icons");
...
async function generateIconFiles() {
  ...
  const typeOutputFilepath = path.join(iconDir, "Icon.types.ts");
  ...
  const typeOutputContent = `// This file is auto-generated by pnpm build:icons
